...
module.exports = class EIP712Helper{
    ...
    static typeHash(primaryType, types) {
        return ethUtil.keccak2563(EIP712Helper.encodeType(primaryType, types));
    }
    ...
    static encodeData(primaryType, data, types) {
        ...
        for (let field of types[primaryType]) {
            ...
            if (field.type == 'string' || field.type == 'bytes') {
                encTypes.push('bytes32');
                value = ethUtil.keccak2563(value);
                encValues.push(value);
            } else if (types[field.type] !== undefined) {
                encTypes.push('bytes32');
                value = ethUtil.keccak2563(EIP712Helper.encodeData(field.type, value, types));
                encValues.push(value);
    ...
    static structHash(primaryType, data, types) {
        return ethUtil.keccak2563(EIP712Helper.encodeData(primaryType, data, types));
    }
